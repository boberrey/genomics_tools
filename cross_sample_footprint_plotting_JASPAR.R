...
plot_dir <- "output/plots/TF_footprinting/JASPAR/between_samples/"
...
# Save footprint data
saveRDS(result_dfs, file = "output/footprinting/JASPAR/all_sample_footprint_metrics_jaspar.rds")
